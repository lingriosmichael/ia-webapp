...
import { d as useRequireAuth, t as ApiError } from "./use-auth-CbwAMR7f.mjs";
import { t as useTranslation } from "../_libs/react-i18next.mjs";
import { B as TriangleAlert, C as FileSpreadsheet, D as Clock3, K as CircleCheck, V as Sparkles, W as CloudUpload, r as Workflow, x as FolderKanban } from "../_libs/lucide-react.mjs";
import { i as TopBar, n as PageHeader, t as Card } from "./WorkspaceUI-JmFi-JKL.mjs";
import { a as useActivityUploadsQuery, f as useJobQuery, i as useActivityResultsQuery, n as useActivityJobsQuery, r as useActivityQuery, v as useProjectQuery, x as useUploadActivityFileMutation } from "./use-grantready-DIPYOCni.mjs";
...
import { t as Route } from "./overview-FSNBZIcV.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/overview-Ct07RsXB.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TopBar, { crumbs: [
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(OverviewHero, {
				...
				latestJobStatus,
				onOpenUploader: () => {
					if (canUploadEvidence) setShowUploader(true);
				},
				canUploadEvidence
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			canUploadEvidence && shouldShowUploader && !uploadMutation.isPending && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UploadComposer, {
				file,
				dragActive,
				inputRef,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
					...
					children: [
						...
						}) : workflowState.key !== "empty" && canUploadEvidence ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
...
function OverviewHero({ state, projectId, activityId, unresolvedIssues, lastUploadName, latestJobStatus, onOpenUploader, canUploadEvidence }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: state === "ready" && canUploadEvidence ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
				...
				})] }) : (state === "empty" || state === "attention") && canUploadEvidence ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					type: "button",
					onClick: onOpenUploader,
					className: "inline-flex h-11 items-center gap-2 rounded-md bg-primary px-5 text-sm font-medium text-primary-foreground shadow hover:bg-primary/90",
