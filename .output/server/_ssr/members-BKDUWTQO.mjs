...
import { p as useOrganizationInvitationsQuery, s as useCreateInvitationMutation, y as useRemoveOrganizationMemberMutation } from "./use-grantready-DIPYOCni.mjs";
import { n as toast } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/members-BKDUWTQO.js
...
function OrganizationMembersPage() {
	...
	const invitationsQuery = useOrganizationInvitationsQuery(organizationId, workspace.organization.permissions.canManageMembers);
	...
	if (!workspace.organization.permissions.canManageMembers) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Navigate, {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TopBar, { crumbs: [{
		...
		to: "/organizations/$organizationId",
		params: { organizationId }
	}, { label: locale.sidebar.members }] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: locale.members.inviteTitle
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-2 text-sm leading-6 text-muted-foreground",
						children: locale.members.inviteDescription
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: locale.members.projectManagerRole
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								children: createInvitationMutation.isPending ? locale.members.inviting : locale.members.sendInvitation
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-sm font-semibold tracking-tight text-foreground",
							children: locale.members.pendingInvitations
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: (invitationsQuery.data ?? []).filter((invitation) => invitation.status === "pending").map((invitation) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: locale.members.pendingStatus
								})]
							}, invitation.id))
						})]
					})
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "text-sm font-semibold tracking-tight text-foreground",
					children: locale.members.currentMembers
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-4 space-y-3",
					children: members.map((member) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: member.role === "ORGANIZATION_ADMIN" ? locale.members.organizationAdminRole : locale.members.projectManagerRole
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								onClick: () => removeMember(member.id),
								className: "text-sm font-medium text-destructive",
								children: locale.members.removeAction
							})]
						})]
					}, member.id))
				})]
...
//#endregion
export { OrganizationMembersPage as component };
