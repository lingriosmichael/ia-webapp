...
import { t as Route$4 } from "../_projectId-DYjXfIkJ.mjs";
import { n as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { r as QueryClientProvider } from "../_libs/tanstack__react-query.mjs";
import { n as initReactI18next, t as useTranslation } from "../_libs/react-i18next.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
import { t as Route$5 } from "./analysis-DnWZe14Q.mjs";
import { t as Route$6 } from "./analytics-CZdRU5GT.mjs";
import { t as Route$7 } from "./analytics-Cg4jD3Ck.mjs";
import { t as Route$8 } from "./brief-COunA5k5.mjs";
import { t as Route$9 } from "./data-review-e8452Pm_.mjs";
import { t as Route$10 } from "./insights-CJWr9Zge.mjs";
import { t as Route$11 } from "./insights-BVlzm3es.mjs";
import { t as Route$12 } from "./overview-DlPoGp6R.mjs";
import { t as Route$13 } from "./processing-B1XaKgdJ.mjs";
import { t as Route$14 } from "./route-UAZJQWX9.mjs";
import { t as Route$15 } from "./route-C1a0K7Ro.mjs";
import { t as Route$16 } from "./settings-BJRd6qss.mjs";
import { t as Route$17 } from "./upload-DsHLNXiy.mjs";
import { t as Route$18 } from "./settings-CWgFlfas.mjs";
import { t as Route$19 } from "./schema-B66tzIUR.mjs";
import { t as instance } from "../_libs/i18next.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-DHmoAgqK.js
...
var de = {
	...
	landing: {
		...
		description: "Starten Sie mit dem tatsächlichen Arbeitsablauf Ihres Teams: Organisation anlegen, Projekte erstellen, Aktivitäten verwalten, Nachweise hochladen und Job-Metadaten in einem echten Backend speichern.",
		createWorkspace: "Workspace erstellen",
		useExistingAccount: "Vorhandenes Konto nutzen",
		features: {
			organizations: {
				title: "Organisationen",
				description: "Jedes Konto startet in einem Organisations-Workspace mit klaren Rollen und Zugriffsrechten."
			},
			projects: {
				title: "Projekte",
				description: "Projekte bilden die Förder- oder Programmstruktur, in der die Evidenzarbeit organisiert wird."
			},
			activities: {
				title: "Aktivitäten",
				description: "Aktivitäten gehören zu Projekten und sind der Anker für Uploads, Jobs und Ergebnisverläufe."
			}
		}
	},
	auth: {
		...
		registerMarketingDescription: "Das erste Konto wird Eigentümer einer neuen Organisation. Danach können Sie Projekte anlegen, Aktivitäten hinzufügen und Nachweise hochladen.",
		loginTitle: "Anmelden",
		loginDescription: "Melden Sie sich an, um auf Ihren Organisations-Workspace zuzugreifen.",
		registerTitle: "Konto erstellen",
		registerDescription: "Registrieren Sie Ihr Eigentümerkonto und Ihre erste Organisation.",
		email: "E-Mail",
		password: "Passwort",
		...
		registerNoOrganizationToast: "Die Registrierung war erfolgreich, aber es wurde keine Organisation erstellt.",
	...
	activityBrief: {
		...
		uploader: {
			...
			description: "Laden Sie eine CSV- oder Excel-Datei hoch. GrantReady AI führt Sie von hier aus durch Prüfung, Analyse und Erkenntnisse.",
	...
	schemaReview: {
		...
		description: "GrantReady AI ordnet jede hochgeladene Spalte ein, markiert personenbezogene Daten und empfiehlt sichere Transformationen, bevor die Interpretation weitergeht.",
		cta: {
		...
		empty: {
			...
			description: "Sobald Sie eine CSV- oder Excel-Datei hochladen, liest GrantReady AI die Struktur, versteht die Felder, erkennt personenbezogene Daten und bereitet alles für die Interpretation vor.",
			benefits: [
...
var en = {
	...
	landing: {
		...
		description: "Start with the workflow your team will actually use: onboard an organization, create projects, track activities, upload evidence, and store job metadata on a real backend.",
		createWorkspace: "Create workspace",
		useExistingAccount: "Use existing account",
		features: {
			organizations: {
				title: "Organizations",
				description: "Each account starts inside an organization workspace with scoped access and ownership."
			},
			projects: {
				title: "Projects",
				description: "Projects become the funding or programme containers where evidence work is organized."
			},
			activities: {
				title: "Activities",
				description: "Activities sit under projects and become the target for uploads, jobs, and result history."
			}
		}
	},
	auth: {
		...
		registerMarketingDescription: "Your first account becomes the owner of a new organization. From there you can create projects, add activities, and upload evidence.",
		loginTitle: "Log in",
		...
		registerNoOrganizationToast: "Registration succeeded but no organization was created.",
	...
	activityBrief: {
		...
		uploader: {
			...
			description: "Upload one CSV or Excel file and GrantReady AI will guide you through review, analysis, and insights from here.",
			cta: "Start AI review",
			remove: "Remove"
		},
		detail: {
	...
	schemaReview: {
		...
		description: "GrantReady AI maps each uploaded column, flags personal data, and recommends safe transformations before interpretation continues.",
		cta: {
		...
		empty: {
			...
			description: "Once you upload a CSV or Excel file, GrantReady AI will read the structure, understand each field, identify personal data, and prepare it for interpretation.",
			benefits: [
...
var ProjectsProjectIdRouteRoute = Route$14.update({
...
var ProjectsProjectIdIndexRoute = Route$4.update({
	id: "/",
	path: "/",
	getParentRoute: () => ProjectsProjectIdRouteRoute
});
var ProjectsProjectIdSettingsRoute = Route$16.update({
	id: "/settings",
	path: "/settings",
	getParentRoute: () => ProjectsProjectIdRouteRoute
});
var ProjectsProjectIdInsightsRoute = Route$10.update({
	id: "/insights",
	path: "/insights",
	getParentRoute: () => ProjectsProjectIdRouteRoute
});
var ProjectsProjectIdAnalyticsRoute = Route$6.update({
	id: "/analytics",
	path: "/analytics",
	getParentRoute: () => ProjectsProjectIdRouteRoute
});
var ProjectsProjectIdActivitiesActivityIdUploadRoute = Route$17.update({
	id: "/activities/$activityId/upload",
	path: "/activities/$activityId/upload",
	getParentRoute: () => ProjectsProjectIdRouteRoute
});
var ProjectsProjectIdActivitiesActivityIdSettingsRoute = Route$18.update({
	id: "/activities/$activityId/settings",
	path: "/activities/$activityId/settings",
	getParentRoute: () => ProjectsProjectIdRouteRoute
});
var ProjectsProjectIdActivitiesActivityIdSchemaRoute = Route$19.update({
	id: "/activities/$activityId/schema",
	path: "/activities/$activityId/schema",
	getParentRoute: () => ProjectsProjectIdRouteRoute
});
var ProjectsProjectIdActivitiesActivityIdProcessingRoute = Route$13.update({
	id: "/activities/$activityId/processing",
	path: "/activities/$activityId/processing",
	getParentRoute: () => ProjectsProjectIdRouteRoute
});
var ProjectsProjectIdActivitiesActivityIdOverviewRoute = Route$12.update({
	id: "/activities/$activityId/overview",
	path: "/activities/$activityId/overview",
	getParentRoute: () => ProjectsProjectIdRouteRoute
});
var ProjectsProjectIdActivitiesActivityIdInsightsRoute = Route$11.update({
	id: "/activities/$activityId/insights",
	path: "/activities/$activityId/insights",
	getParentRoute: () => ProjectsProjectIdRouteRoute
});
var ProjectsProjectIdActivitiesActivityIdDataReviewRoute = Route$9.update({
	id: "/activities/$activityId/data-review",
	path: "/activities/$activityId/data-review",
	getParentRoute: () => ProjectsProjectIdRouteRoute
});
var ProjectsProjectIdActivitiesActivityIdBriefRoute = Route$8.update({
	id: "/activities/$activityId/brief",
	path: "/activities/$activityId/brief",
	getParentRoute: () => ProjectsProjectIdRouteRoute
});
var ProjectsProjectIdActivitiesActivityIdAnalyticsRoute = Route$7.update({
...
var ProjectsProjectIdRouteRouteChildren = {
	...
	ProjectsProjectIdActivitiesActivityIdAnalysisRoute: Route$5.update({
