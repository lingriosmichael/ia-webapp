import { t as Route } from "./analytics-CoAS_6t5.js";
import { a as useRequireAuth } from "./use-auth-CbwAMR7f.js";
import { g as useProjectActivitiesQuery, v as useProjectQuery } from "./use-grantready-DIPYOCni.js";
import { i as TopBar, n as PageHeader, r as Stat, t as Card } from "./WorkspaceUI-JmFi-JKL.js";
import { a as getKeyMetrics, i as getCompletionByAgeGroup, l as trendsByWeek, o as getMentorMatching, r as getAttendanceDistribution, t as confidenceImprovement } from "./mock-data-DNCOsgtW.js";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useTranslation } from "react-i18next";
import { Area, AreaChart, Bar, BarChart, CartesianGrid, Cell, Line, LineChart, Pie, PieChart, ResponsiveContainer, Tooltip, XAxis, YAxis } from "recharts";
//#region src/routes/projects/$projectId/analytics.tsx?tsr-split=component
var COLORS = [
	"oklch(0.55 0.22 295)",
	"oklch(0.65 0.18 250)",
	"oklch(0.7 0.16 180)",
...
function ProjectAnalytics() {
	...
	if (!auth.token || projectQuery.isLoading || activitiesQuery.isLoading) return /* @__PURE__ */ jsx(CenteredState, { label: t("projectAnalytics.loading") });
	if (!projectQuery.data || !activitiesQuery.data) return /* @__PURE__ */ jsx(CenteredState, { label: t("projectAnalytics.loadFailed") });
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(TopBar, { crumbs: [
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: keyMetrics.map((metric) => /* @__PURE__ */ jsx(Stat, {
					label: metric.label,
					value: metric.value,
					delta: metric.delta
				}, metric.key))
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(ChartCard, {
						...
						children: [/* @__PURE__ */ jsx(ResponsiveContainer, { children: /* @__PURE__ */ jsxs(PieChart, { children: [/* @__PURE__ */ jsx(Tooltip, { contentStyle: tooltipStyle }), /* @__PURE__ */ jsx(Pie, {
							data: mentorMatching,
							dataKey: "value",
							nameKey: "name",
							innerRadius: 60,
							outerRadius: 90,
							paddingAngle: 2,
							children: mentorMatching.map((_, index) => /* @__PURE__ */ jsx(Cell, { fill: COLORS[index] }, index))
						})] }) }), /* @__PURE__ */ jsx("div", {
							className: "mt-2 flex justify-center gap-4 text-[11px]",
							children: mentorMatching.map((item, index) => /* @__PURE__ */ jsxs("span", {
