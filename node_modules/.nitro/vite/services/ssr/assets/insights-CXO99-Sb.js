import { t as Route } from "./insights-XvoBgZbc.js";
...
//#region src/routes/projects/$projectId/insights.tsx?tsr-split=component
function ProjectInsights() {
	...
	if (!auth.token || projectQuery.isLoading || activitiesQuery.isLoading) return /* @__PURE__ */ jsx(CenteredState, { label: t("projectInsights.loading") });
	if (!projectQuery.data || !activitiesQuery.data) return /* @__PURE__ */ jsx(CenteredState, { label: t("projectInsights.loadFailed") });
		...
		children: [
			...
			/* @__PURE__ */ jsxs(Card, {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: projectInsights.privacy.map((item, index) => /* @__PURE__ */ jsx("li", {
	...
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: items.map((item, index) => /* @__PURE__ */ jsxs("li", {
				...
				children: [/* @__PURE__ */ jsx("span", { className: "mt-1.5 h-1 w-1 shrink-0 rounded-full bg-primary" }), /* @__PURE__ */ jsx("span", { children: item })]
			}, index))
		})]
	});
}
