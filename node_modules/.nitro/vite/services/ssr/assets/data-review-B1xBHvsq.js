import { t as Route } from "./data-review-e8452Pm_.js";
import { a as useRequireAuth, f as cn } from "./use-auth-CH-EBljn.js";
import { i as TopBar, n as PageHeader, t as Card } from "./WorkspaceUI-BGreAxnr.js";
import { f as useProjectQuery, i as useActivityUploadsQuery, n as useActivityQuery, t as useActivityJobsQuery } from "./use-grantready-B9_7M9rF.js";
import { t as ActivityTabs } from "./ActivityTabs-bEUyNi9r.js";
import { c as getSchema, n as datasetOverview } from "./mock-data-DNCOsgtW.js";
import { t as formatDateTime } from "./translation-utils-79g5PT3p.js";
import { useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useTranslation } from "react-i18next";
import { AlertTriangle, ArrowRight, Check, CheckCircle2, CircleHelp, FileSpreadsheet, MapPinned, Search, ShieldCheck, Sparkles, UploadCloud, X } from "lucide-react";
//#region src/routes/projects/$projectId/activities/$activityId/data-review.tsx?tsr-split=component
var privacyTone = {
...
function SchemaReview() {
	...
	if (!auth.token || projectQuery.isLoading || activityQuery.isLoading || uploadsQuery.isLoading || jobsQuery.isLoading) return /* @__PURE__ */ jsx(CenteredState, { label: t("schemaReview.loading") });
	if (!projectQuery.data || !activityQuery.data) return /* @__PURE__ */ jsx(CenteredState, { label: t("schemaReview.loadFailed") });
	...
	const pageAction = !hasDataset ? /* @__PURE__ */ jsxs(Link, {
		...
		children: [/* @__PURE__ */ jsx(UploadCloud, { className: "h-4 w-4" }), t("schemaReview.cta.uploadDataset")]
	}) : unresolvedCount > 0 ? /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(AlertTriangle, { className: "h-4 w-4" }), t("schemaReview.cta.reviewRequired", { count: unresolvedCount })]
	}) : /* @__PURE__ */ jsxs(Link, {
		...
		className: "inline-flex h-10 items-center gap-2 rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground shadow hover:bg-primary/90",
		children: [t("schemaReview.cta.continueToAnalysis"), /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
	});
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(TopBar, { crumbs: [
		...
		children: [
			...
			/* @__PURE__ */ jsx(ActivityTabs, {
				projectId,
				activityId,
				className: "mt-6"
			}),
			!hasDataset ? /* @__PURE__ */ jsx(EmptyDatasetState, {
				projectId,
				activityId
			}) : /* @__PURE__ */ jsxs(Fragment, { children: [
				/* @__PURE__ */ jsx(DatasetStatusCard, {
				...
				/* @__PURE__ */ jsx(WorkflowProgress, { steps: [
					{
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(SummaryMetric, {
							icon: /* @__PURE__ */ jsx(FileSpreadsheet, { className: "h-4 w-4 text-primary" }),
							label: t("schemaReview.summary.columnsDetected"),
							value: String(schema.length)
						}),
						/* @__PURE__ */ jsx(SummaryMetric, {
							icon: /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-primary" }),
						...
						/* @__PURE__ */ jsx(SummaryMetric, {
							icon: /* @__PURE__ */ jsx(AlertTriangle, { className: "h-4 w-4 text-primary" }),
				...
				/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [
											/* @__PURE__ */ jsx("div", { children: t("schemaReview.headers.originalName") }),
											/* @__PURE__ */ jsx("div", { children: t("schemaReview.headers.semanticMeaning") }),
											/* @__PURE__ */ jsx("div", { children: t("schemaReview.headers.privacyCategory") }),
											/* @__PURE__ */ jsx("div", { children: t("schemaReview.headers.transformation") }),
											/* @__PURE__ */ jsx("div", { children: t("schemaReview.headers.confidence") })
										]
									}), /* @__PURE__ */ jsx("ul", { children: filteredSchema.map((column) => {
										...
										return /* @__PURE__ */ jsx("li", {
											...
											children: /* @__PURE__ */ jsxs("button", {
												...
												children: [
													...
													}), confirmedSelections[column.original] ? /* @__PURE__ */ jsx("div", {
					...
					}), /* @__PURE__ */ jsx(ColumnDetailPanel, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5" }), t("schemaReview.empty.eyebrow")]
				}),
				/* @__PURE__ */ jsx("h2", {
				...
				/* @__PURE__ */ jsx("ul", {
					...
					children: benefits.map((benefit) => /* @__PURE__ */ jsxs("li", {
						className: "flex items-start gap-3 rounded-xl border border-primary/10 bg-card/70 px-4 py-3 text-sm text-foreground",
						children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "mt-0.5 h-4 w-4 shrink-0 text-primary" }), /* @__PURE__ */ jsx("span", { children: benefit })]
					}, benefit))
				}),
				/* @__PURE__ */ jsx("div", {
					className: "mt-6",
					children: /* @__PURE__ */ jsxs(Link, {
						...
						className: "inline-flex h-10 items-center gap-2 rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground shadow hover:bg-primary/90",
						children: [/* @__PURE__ */ jsx(UploadCloud, { className: "h-4 w-4" }), t("schemaReview.empty.cta")]
					})
				})
			]
		})
...
function DatasetStatusCard({ title, description, meta, tone }) {
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [tone === "ready" ? /* @__PURE__ */ jsx(ShieldCheck, { className: "mt-0.5 h-4 w-4 shrink-0 text-primary" }) : /* @__PURE__ */ jsx(AlertTriangle, { className: "mt-0.5 h-4 w-4 shrink-0 text-[oklch(0.45_0.16_75)]" }), /* @__PURE__ */ jsxs("div", { children: [
			/* @__PURE__ */ jsx("div", {
...
function WorkflowProgress({ steps }) {
	return /* @__PURE__ */ jsx(Card, {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: steps.map((step, index) => /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", {
						...
						children: step.state === "complete" ? /* @__PURE__ */ jsx(Check, { className: "h-3.5 w-3.5" }) : index + 1
					}), /* @__PURE__ */ jsx("span", {
...
function ConfidenceBadge({ status, value }) {
	...
	const icon = status === "confirmed" ? /* @__PURE__ */ jsx(Check, { className: "h-3.5 w-3.5" }) : status === "high" ? /* @__PURE__ */ jsx(CheckCircle2, { className: "h-3.5 w-3.5" }) : status === "review" ? /* @__PURE__ */ jsx(CircleHelp, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ jsx(AlertTriangle, { className: "h-3.5 w-3.5" });
...
function TransformationBadge({ transformation, label }) {
	const icon = transformation === "Hashed" ? /* @__PURE__ */ jsx(ShieldCheck, { className: "h-3.5 w-3.5" }) : transformation === "Generalised" ? /* @__PURE__ */ jsx(MapPinned, { className: "h-3.5 w-3.5" }) : transformation === "Removed" ? /* @__PURE__ */ jsx(X, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ jsx(Check, { className: "h-3.5 w-3.5" });
	return /* @__PURE__ */ jsxs("span", {
		...
		children: /* @__PURE__ */ jsxs(Card, {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					sampleValues.length > 0 ? /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
						className: "text-xs font-semibold uppercase tracking-[0.08em] text-muted-foreground",
						children: t("schemaReview.detail.sampleValues")
					}), /* @__PURE__ */ jsx("div", {
						className: "mt-3 flex flex-wrap gap-2",
						children: sampleValues.map((value) => /* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4 text-primary" }), t("schemaReview.detail.reasoningTitle")]
					}), /* @__PURE__ */ jsx("ul", {
						className: "mt-3 grid gap-2",
						children: reasoning.map((item) => /* @__PURE__ */ jsx("li", {
							className: "rounded-xl border border-border bg-secondary/20 px-4 py-3 text-sm leading-6 text-muted-foreground",
							children: item
						}, item))
					})] }),
					column.clarifyingQuestion ? /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5" }), t("schemaReview.reviewCard.badge")]
							}),
							/* @__PURE__ */ jsx("p", {
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: (Array.isArray(column.clarifyingOptions) ? column.clarifyingOptions : []).map((option) => /* @__PURE__ */ jsx("button", {
