import { t as Route } from "./settings-CH5ywjge.js";
import { a as useRequireAuth } from "./use-auth-CbwAMR7f.js";
import { t as Button } from "./button-Bq5vK6RO.js";
import { h as useOrganizationWorkspaceQuery, v as useProjectQuery } from "./use-grantready-DIPYOCni.js";
import { i as TopBar, n as PageHeader, t as Card } from "./WorkspaceUI-JmFi-JKL.js";
import { t as useWorkspaceLocale } from "./use-workspace-locale-DVjcZ9zV.js";
...
import { CalendarRange, MapPin, ShieldAlert, Target, Trash2 } from "lucide-react";
//#region src/components/ProjectSettingsPanel.tsx
function ProjectSettingsPanel({ project, organizationName, onDeleteProject }) {
	...
	return /* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx(DetailCard, {
							...
							icon: /* @__PURE__ */ jsx(CalendarRange, { className: "h-4 w-4 text-primary" })
						}),
						/* @__PURE__ */ jsx(DetailCard, {
							label: locale.projectSettings.fields.location,
							value: location || locale.projectSettings.notSet,
							icon: /* @__PURE__ */ jsx(MapPin, { className: "h-4 w-4 text-primary" })
						}),
						/* @__PURE__ */ jsx(DetailCard, {
						...
						/* @__PURE__ */ jsx(DetailCard, {
							...
							icon: /* @__PURE__ */ jsx(Target, { className: "h-4 w-4 text-primary" })
						}),
						/* @__PURE__ */ jsx(DetailCard, {
		...
		}), project.permissions.canDelete ? /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs(Card, {
			className: "border-destructive/25 bg-destructive/[0.04] p-6 shadow-none",
			children: [
				/* @__PURE__ */ jsxs("div", {
					className: "flex items-center gap-2 text-sm font-semibold tracking-tight text-foreground",
					children: [/* @__PURE__ */ jsx(ShieldAlert, { className: "h-4 w-4 text-destructive" }), locale.projectSettings.dangerTitle]
				}),
				/* @__PURE__ */ jsx("p", {
				...
				/* @__PURE__ */ jsxs(Button, {
					...
					children: [/* @__PURE__ */ jsx(Trash2, { className: "h-4 w-4" }), locale.projectSettings.deleteAction]
				})
			]
		}) }) : null]
	});
...
//#endregion
//#region src/routes/projects/$projectId/settings.tsx?tsr-split=component
function ProjectSettingsPage() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(TopBar, { crumbs: [
		...
		}), /* @__PURE__ */ jsx(ProjectSettingsPanel, {
			project,
