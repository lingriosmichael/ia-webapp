import { t as Route } from "./overview-FSNBZIcV.js";
import { t as cn } from "./utils-C_uf36nf.js";
import { a as useRequireAuth, s as ApiError } from "./use-auth-CbwAMR7f.js";
import { a as useActivityUploadsQuery, f as useJobQuery, i as useActivityResultsQuery, n as useActivityJobsQuery, r as useActivityQuery, v as useProjectQuery, x as useUploadActivityFileMutation } from "./use-grantready-DIPYOCni.js";
import { i as TopBar, n as PageHeader, t as Card } from "./WorkspaceUI-JmFi-JKL.js";
import { t as ActivityTabs } from "./ActivityTabs-cP5SB4J9.js";
...
import { AlertTriangle, CheckCircle2, Clock3, CloudUpload, FileSpreadsheet, FolderKanban, Sparkles, UploadCloud, Workflow } from "lucide-react";
//#region src/routes/projects/$projectId/activities/$activityId/overview.tsx?tsr-split=component
function ActivityBriefPage() {
	...
	if (!auth.token || projectQuery.isLoading || activityQuery.isLoading || uploadsQuery.isLoading || jobsQuery.isLoading || resultsQuery.isLoading || Boolean(latestJobId) && latestJobQuery.isLoading) return /* @__PURE__ */ jsx(CenteredState, { label: t("activityBrief.loading") });
	if (!projectQuery.data || !activityQuery.data) return /* @__PURE__ */ jsx(CenteredState, { label: t("activityBrief.loadFailed") });
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(TopBar, { crumbs: [
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx(ActivityMetricCard, {
						icon: /* @__PURE__ */ jsx(Workflow, { className: "h-4 w-4 text-primary" }),
					...
					/* @__PURE__ */ jsx(ActivityMetricCard, {
						icon: /* @__PURE__ */ jsx(FolderKanban, { className: "h-4 w-4 text-primary" }),
						label: t("activityBrief.metrics.project"),
						value: project.name,
						description: project.programGoal ?? t("activityBrief.detail.noProjectGoal")
					}),
					/* @__PURE__ */ jsx(ActivityMetricCard, {
						icon: /* @__PURE__ */ jsx(UploadCloud, { className: "h-4 w-4 text-primary" }),
			...
			workflowState.key === "processing" && /* @__PURE__ */ jsx(PipelineCard, {
				status: latestJobStatus,
				title: t("activityBrief.pipeline.title"),
				description: t("activityBrief.pipeline.description"),
				stages: pipelineStages
			}),
			canUploadEvidence && shouldShowUploader && !uploadMutation.isPending && /* @__PURE__ */ jsx(UploadComposer, {
				file,
				dragActive,
				inputRef,
				...
				children: [/* @__PURE__ */ jsxs(Card, {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4 text-primary" }), t("activityBrief.nextStep.title")]
						}),
						/* @__PURE__ */ jsx("p", {
						...
						}) : workflowState.key !== "empty" && canUploadEvidence ? /* @__PURE__ */ jsx("button", {
							type: "button",
					...
					children: [/* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-2 text-sm font-semibold tracking-tight",
						children: [/* @__PURE__ */ jsx(FileSpreadsheet, { className: "h-4 w-4 text-primary" }), t("activityBrief.evidence.title")]
					}), /* @__PURE__ */ jsxs("dl", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [state === "ready" ? /* @__PURE__ */ jsx(CheckCircle2, { className: "h-3.5 w-3.5" }) : state === "uploading" || state === "processing" ? /* @__PURE__ */ jsx(Clock3, { className: "h-3.5 w-3.5" }) : state === "attention" ? /* @__PURE__ */ jsx(AlertTriangle, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ jsx(Workflow, { className: "h-3.5 w-3.5" }), t(`activityBrief.hero.badges.${state}`)]
					}),
					/* @__PURE__ */ jsx("h2", {
					...
					state === "processing" ? /* @__PURE__ */ jsx("p", {
				...
				children: state === "ready" && canUploadEvidence ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Link, {
					...
					children: [/* @__PURE__ */ jsx(UploadCloud, { className: "h-4 w-4" }), t("activityBrief.hero.uploadAnother")]
				})] }) : (state === "empty" || state === "attention") && canUploadEvidence ? /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: onOpenUploader,
					className: "inline-flex h-11 items-center gap-2 rounded-md bg-primary px-5 text-sm font-medium text-primary-foreground shadow hover:bg-primary/90",
					children: [/* @__PURE__ */ jsx(UploadCloud, { className: "h-4 w-4" }), t("activityBrief.hero.uploadFirstDataset")]
				}) : null
			})]
		}), state === "uploading" ? /* @__PURE__ */ jsxs("div", {
			className: "mt-8 rounded-2xl border border-primary/15 bg-card/80 p-5",
			children: [
				/* @__PURE__ */ jsxs("div", {
					className: "flex items-center justify-between text-sm font-medium",
					children: [/* @__PURE__ */ jsx("span", { children: t("activityBrief.uploading.title") }), /* @__PURE__ */ jsx("span", { children: t("activityBrief.uploading.inProgress") })]
				}),
				/* @__PURE__ */ jsx("div", {
					className: "mt-3 h-2 overflow-hidden rounded-full bg-secondary",
					children: /* @__PURE__ */ jsx("div", { className: "h-full w-2/3 animate-pulse rounded-full bg-gradient-to-r from-primary to-[oklch(0.65_0.22_310)]" })
				}),
				/* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(CloudUpload, { className: "h-6 w-6" })
					}),
					/* @__PURE__ */ jsx("div", {
			...
			file ? /* @__PURE__ */ jsxs(Card, {
				...
				children: [
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx(FileSpreadsheet, { className: "h-5 w-5" })
					}),
					/* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4" }), isUploading ? t("upload.uploading") : t("activityBrief.uploader.cta")]
					})
				]
			}) : null
		]
...
function PipelineCard({ status, title, description, stages }) {
	...
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				className: "flex items-center gap-2 text-sm font-semibold tracking-tight",
				children: [/* @__PURE__ */ jsx(Workflow, { className: "h-4 w-4 text-primary" }), title]
			}),
			/* @__PURE__ */ jsx("p", {
				className: "mt-2 text-sm leading-6 text-muted-foreground",
					...
					return /* @__PURE__ */ jsx("li", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", {
								...
								children: state === "complete" ? /* @__PURE__ */ jsx(CheckCircle2, { className: "h-3.5 w-3.5" }) : index + 1
							}), /* @__PURE__ */ jsx("span", {
