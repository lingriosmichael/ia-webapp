import { t as LanguageSwitcher } from "./LanguageSwitcher-DqiLzln-.js";
import { Link, useRouterState } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { useTranslation } from "react-i18next";
import { ChevronRight, Command, Search } from "lucide-react";
//#region src/components/WorkspaceUI.tsx
	...
	return /* @__PURE__ */ jsxs("header", {
		...
		children: [/* @__PURE__ */ jsx("nav", {
			...
			children: crumbs.map((c, i) => /* @__PURE__ */ jsxs("span", {
				...
				children: [i > 0 && /* @__PURE__ */ jsx(ChevronRight, { className: "h-3.5 w-3.5 opacity-50" }), c.to ? /* @__PURE__ */ jsx(Link, {
					to: c.to,
					params: c.params,
			...
			children: [
				/* @__PURE__ */ jsxs("button", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("span", { children: t("common.search") }),
						/* @__PURE__ */ jsxs("span", {
