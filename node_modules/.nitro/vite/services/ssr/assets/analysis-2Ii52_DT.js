import { t as Route } from "./analysis-DnWZe14Q.js";
...
import { f as useProjectQuery, i as useActivityUploadsQuery, n as useActivityQuery, r as useActivityResultsQuery, t as useActivityJobsQuery } from "./use-grantready-B9_7M9rF.js";
import { t as ActivityTabs } from "./ActivityTabs-bEUyNi9r.js";
import { a as getKeyMetrics, c as getSchema, n as datasetOverview } from "./mock-data-DNCOsgtW.js";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useTranslation } from "react-i18next";
import { BarChart3, CheckCircle2, Database, FileSpreadsheet, Sparkles } from "lucide-react";
//#region src/routes/projects/$projectId/activities/$activityId/analysis.tsx?tsr-split=component
function ActivityAnalyticsPage() {
	...
	if (!auth.token || projectQuery.isLoading || activityQuery.isLoading || uploadsQuery.isLoading || jobsQuery.isLoading || resultsQuery.isLoading) return /* @__PURE__ */ jsx(CenteredState, { label: t("activityAnalytics.loading") });
	if (!projectQuery.data || !activityQuery.data) return /* @__PURE__ */ jsx(CenteredState, { label: t("activityAnalytics.loadFailed") });
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(TopBar, { crumbs: [
		...
		children: [
			...
			!hasDataset ? /* @__PURE__ */ jsx(WorkflowGate, {
			...
			}) : isProcessing ? /* @__PURE__ */ jsx(WorkflowGate, {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(MiniCard, {
							icon: /* @__PURE__ */ jsx(Database, { className: "h-4 w-4 text-primary" }),
				...
				/* @__PURE__ */ jsxs(Card, {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(BarChart3, { className: "h-4 w-4 text-primary" }), t("activityAnalytics.metricsTitle")]
					}), /* @__PURE__ */ jsx("div", {
						className: "mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4",
						children: keyMetrics.map((metric) => /* @__PURE__ */ jsxs("div", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs(Card, {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: storyPoints.map((item) => /* @__PURE__ */ jsx("li", { children: item }, item))
						})]
					}), /* @__PURE__ */ jsxs(Card, {
						className: "p-6",
						children: [
