import { t as Route } from "./insights-BVlzm3es.js";
...
import { f as useProjectQuery, n as useActivityQuery, r as useActivityResultsQuery } from "./use-grantready-B9_7M9rF.js";
import { t as ActivityTabs } from "./ActivityTabs-bEUyNi9r.js";
import { s as getProjectInsights } from "./mock-data-DNCOsgtW.js";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { useTranslation } from "react-i18next";
import { Lightbulb, ShieldCheck, Sparkles } from "lucide-react";
//#region src/routes/projects/$projectId/activities/$activityId/insights.tsx?tsr-split=component
function ActivityInsightsPage() {
	...
	if (!auth.token || projectQuery.isLoading || activityQuery.isLoading || resultsQuery.isLoading) return /* @__PURE__ */ jsx(CenteredState, { label: t("activityInsights.loading") });
	if (!projectQuery.data || !activityQuery.data) return /* @__PURE__ */ jsx(CenteredState, { label: t("activityInsights.loadFailed") });
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(TopBar, { crumbs: [
		...
		children: [
			...
			availableInsights === 0 ? /* @__PURE__ */ jsx(Card, {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx(SummaryCard, {
							icon: /* @__PURE__ */ jsx(Lightbulb, { className: "h-4 w-4 text-primary" }),
							label: t("activityInsights.summary.keyFindings"),
							value: String(keyFindings.length)
						}),
						/* @__PURE__ */ jsx(SummaryCard, {
							icon: /* @__PURE__ */ jsx(ShieldCheck, { className: "h-4 w-4 text-primary" }),
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs(Card, {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4 text-primary" }), t("activityInsights.executiveSummaryTitle")]
						}), /* @__PURE__ */ jsx("p", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex items-center gap-2 text-sm font-semibold tracking-tight",
							children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-4 w-4 text-primary" }), t("activityInsights.privacyBoundaryTitle")]
						}), /* @__PURE__ */ jsx("ul", {
							className: "mt-4 space-y-3 text-sm leading-6 text-muted-foreground",
							children: privacyItems.map((item) => /* @__PURE__ */ jsx("li", { children: item }, item))
						})]
					})]
				}),
				/* @__PURE__ */ jsxs("div", {
					className: "mt-6 grid gap-6 xl:grid-cols-2",
					children: [/* @__PURE__ */ jsx(InsightList, {
						title: t("activityInsights.keyFindingsTitle"),
						items: keyFindings
					}), /* @__PURE__ */ jsx(InsightList, {
...
function InsightList({ title, items }) {
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			className: "mt-4 space-y-3 text-sm leading-6 text-muted-foreground",
			children: items.map((item) => /* @__PURE__ */ jsx("li", { children: item }, item))
		})]
	});
}
