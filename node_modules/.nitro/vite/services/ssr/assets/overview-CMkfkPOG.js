import { t as Route } from "./overview-DlPoGp6R.js";
import { a as useRequireAuth, f as cn, s as ApiError } from "./use-auth-CH-EBljn.js";
import { i as TopBar, n as PageHeader, t as Card } from "./WorkspaceUI-BGreAxnr.js";
import { c as useJobQuery, f as useProjectQuery, i as useActivityUploadsQuery, m as useUploadActivityFileMutation, n as useActivityQuery, r as useActivityResultsQuery, t as useActivityJobsQuery } from "./use-grantready-B9_7M9rF.js";
...
function ActivityBriefPage() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(TopBar, { crumbs: [
		...
		children: [
			...
			shouldShowUploader && !uploadMutation.isPending && /* @__PURE__ */ jsx(UploadComposer, {
				file,
				dragActive,
				inputRef,
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(Card, {
					...
					children: [
						...
						}) : workflowState.key !== "empty" ? /* @__PURE__ */ jsx("button", {
							type: "button",
	...
	return /* @__PURE__ */ jsxs(Card, {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: state === "ready" ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Link, {
				...
				})] }) : state === "empty" || state === "attention" ? /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: onOpenUploader,
					className: "inline-flex h-11 items-center gap-2 rounded-md bg-primary px-5 text-sm font-medium text-primary-foreground shadow hover:bg-primary/90",
