  ...
  return [
    ...
    },
    {
      ...
      clarifyingQuestion: t(
        "schemaReview.schema.mentor_match_status.clarifyingQuestion",
      ),
...
export function getProjectInsights(t: TFunction) {
  return {
    ...
    keyFindings: t("projectInsights.keyFindings", {
      returnObjects: true,
    }) as string[],
    interestingPatterns: t("projectInsights.interestingPatterns", {
      returnObjects: true,
    }) as string[],
    evidenceGaps: t("projectInsights.evidenceGaps", {
      returnObjects: true,
    }) as string[],
    recommendations: t("projectInsights.recommendations", {
      returnObjects: true,
    }) as string[],
