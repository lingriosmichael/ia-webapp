...
const de: TranslationDictionary = {
  ...
  projectAnalytics: {
    ...
    metrics: {
      participants: { label: 'Teilnehmende', delta: '+12 gegenüber letztem Zyklus' },
      attendanceRate: { label: 'Teilnahmequote', delta: '+4 Punkte' },
      programmeCompletion: { label: 'Programmabschluss', delta: '+6 Punkte' },
      confidenceImprovement: { label: 'Vertrauenszuwachs', delta: 'Skala 1–10' },
      missingValues: { label: 'Fehlende Werte', delta: '1,1 % der Zellen' },
      duplicateRows: { label: 'Doppelte Zeilen', delta: 'automatisch markiert' },
    },
    mentorMatching: {
      matched: 'Zugeordnet',
      pending: 'Ausstehend',
